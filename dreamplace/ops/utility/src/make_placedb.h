...
LegalizationDB<T> make_placedb(
    ...
    int num_filler_nodes, int num_parity_cells,
  ...
  db.num_parity_cells = num_parity_cells;
  db.wm_parity_cells = DREAMPLACE_TENSOR_DATA_PTR(wm_parity_cells, int);
  db.wm_parity_keys = DREAMPLACE_TENSOR_DATA_PTR(wm_parity_keys, int);
