...
class PlaceDrawer {
 public:
  ...
  PlaceDrawer(
      ...
      const index_type* pin2node_map, const index_type* watermark_cells,
      ...
      : m_x(x),
        ...
        m_watermark_cells(watermark_cells),
 ...
 protected:
  ...
  const index_type* m_watermark_cells;
